...
class Fmt {
  ...
  static String blockToTime(int? blocks, int blockDuration,
    ...
    if (day > 0) {
      res =
      '$day ${locale.contains('zh') ? "天" : "days"} $hour ${locale.contains(
          'zh') ? "小时" : "hrs"}';
    } else if (hour > 0) {
  ...
  static String doubleFormat(double? value, {
    int length = 4,
    int round = 0,
  }) {
    if (value == null) {
  ...
  static String priceCeil(double? value, {
    int lengthFixed = 2,
    int? lengthMax,
  }) {
    if (value == null) {
  ...
  static String priceFloor(double? value, {
    int lengthFixed = 2,
    int? lengthMax,
  }) {
    if (value == null) {
